	...
	<div class="joinchat__chatbox">
		<div class="joinchat__header">
			<div id="joinchat__label">
				<a class="joinchat__powered <?php echo '__jc__' !== $settings['header'] ? 'joinchat--hidden' : ''; ?>" href="<?php echo esc_url( $powered_link ); ?>" rel="nofollow noopener" target="_blank">
				...
				<?php if ( in_array( $settings['header'], array( '__jc__', '__wa__' ), true ) ) : ?>
					<span class="joinchat__header__text joinchat--hidden"></span>
				<?php else : ?>
		...
		<div class="joinchat__scroll">
			<div class="joinchat__content">
				...
				<div class="joinchat__open" role="button" tabindex="0">
					...
					<svg class="joinchat__open__icon" width="60" height="60" viewbox="0 0 400 400" stroke-linecap="round" stroke-width="33">
